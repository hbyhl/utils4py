...
# Author:yhl
# Version:
# Last modified: 2019-12-11 18:33
import codecs
import os
import re
import time
...
class MultiProcessSafeTimedRotatingFileHandler(TimedRotatingFileHandler):
    ...
    def __init__(self, filename, when='h', interval=1, backupCount=0, encoding=None, delay=False, utc=False, atTime=None):
        ...
        TimedRotatingFileHandler.__init__(self, filename, when=when, interval=interval, backupCount=backupCount, encoding=encoding, delay=delay,
